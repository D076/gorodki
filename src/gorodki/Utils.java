...
public class Utils {//изменение размера спрайта и загрузка уровней
    ...
    public static Integer[][] lvlParser(String filePath){//считываем уровень из файла
        Integer[][] result = null;
    ...
    //Вспомогательный метод для загрузки уровня
